...
## Task 1 · 🔥 Publish to TikTok, mirror to Facebook, post the launch story (60–75 min)
...
**Why:** Same math as Avinaya's list — five people who trust you, honestly asked, produce more first workouts than any post today will. Your Android circle also covers the Play side of feedback nobody else on the team can get.
**Where:** Your own contacts (WhatsApp/Messenger/DMs) + the tracker `Outreach` tab.
...
**Steps:**
1. List 20 real contacts in the `Outreach` tab — prioritize Android users (your keyword research means you know exactly what they searched for and didn't find) — with a "why Buzzend fits them" column.
2. Pick today's 5 and write each message from scratch: personal first line about them, one plain sentence on what Buzzend does ("the phone camera counts your reps out loud while you work out"), one honest ask.
3. The ask: "try it and tell me what confused you" — never beg for downloads, never ask for ratings or reviews. No copy-paste: if a friend could tell the message was sent to five people, rewrite it.
4. Include the right store link from `sprint/config.js`. One ask per message.
5. Send all 5, and note anything they report about the new Play listing (you shipped it Day 2 — they're their first real readers).
6. Log the 5 as SENT with today's date in `Outreach`, matching Riya's column format.

**Deliverable:** 20-contact list + 5 personalized messages sent, logged in `Outreach`.
**Done when:** 5 visibly-different messages are sent and all 20 rows exist for the rest of the sprint.
**Depends on:** —
