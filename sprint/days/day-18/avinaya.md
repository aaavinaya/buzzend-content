...
**Steps:**
1. Read Gaurab's how-to-invite-friends.md: could a stranger follow it? Flag any step that assumes knowledge.
2. Check Riya's Challenge-a-Friend posts against the approval card.
3. Verdicts + at most 3 exact fixes in the tracker.

**Deliverable:** Both items verified with verdicts in the tracker.
**Done when:** Owners have your notes same day.
**Depends on:** —
