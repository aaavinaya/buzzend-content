...
exemplars before writing anything: `templates/day1-feed.html` and
`templates/day1-story.html`. Your files must follow the exact same structure,
class names and quality bar.
...
- `templates/dayN-feed.html` — 1080×1080 (Instagram + Facebook feed)
- `templates/dayN-story.html` — 1080×1920 (IG Stories/Reels cover + TikTok + FB story)
